#Github https://github.com/Marcus1218
import pandas as pd
...
def add_expense():
    ...
    # One More Function Enter to be time NOW
    if date_input == '':
...
def update_expenses():
    ...
    amount_input = input("Enter the Amount you want to change:")
    ...
    expenses_df.loc[expenses_df['Description'] == description_input, 'Amount'] = float(amount_input)
    expenses_df.to_csv('expenses.csv', index=False)
